...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Status-Hunting-green?style=for-the-badge" />
</p>

`Web Pentest` • `API Security` • `Mobile Security` • `Cloud Security`
...
Turning security findings into actionable remediation  
...
Web & Mobile Pentesting (Advanced)  
